...
fun mkMainGrp() {
    ...
    val grpBlks = FabricItemGroup.builder().icon {ModBlocks.STAFF_WORKBENCH.asItem().defaultStack}
        .displayName(Text.translatable("itemGroup.nova_arcana.blocks")).entries {_, entries -> run {
            ...
            entries.add(ModBlocks.RITUAL_FORGE)
            entries.add(ModBlocks.RITUAL_HOARD)
            entries.add(ModBlocks.RITUAL_PRISON)
            entries.add(ModBlocks.MANA_VESSEL_ICE)
            entries.add(ModBlocks.MANA_VESSEL_FIRE)
            entries.add(ModBlocks.MANA_VESSEL_EARTH)
            entries.add(ModBlocks.MANA_VESSEL_WIND)
            entries.add(ModBlocks.MANA_VESSEL_SPIRIT)
            entries.add(ModBlocks.MANA_VESSEL_VOID)
        }}.build()
    ...
    val grpMateria = FabricItemGroup.builder().icon { mkMateria("nova_arcana:spell/flame") }
        .displayName(Text.translatable("itemGroup.nova_arcana.spells")).entries {_, entries -> run {
            ...
            entries.add(matStk("magic-missile"))
