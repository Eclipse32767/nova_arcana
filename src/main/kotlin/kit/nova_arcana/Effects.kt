...
import kit.nova_arcana.effects.SoaringBlessing
...
object ModEffects {
    ...
    val SOARING = Registry.register(Registries.STATUS_EFFECT, Identifier("nova_arcana:soaring-blessing"), SoaringBlessing())
}